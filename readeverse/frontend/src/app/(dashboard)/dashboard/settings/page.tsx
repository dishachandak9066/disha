        ...
        <div className="w-full md:w-64 flex-shrink-0 space-y-2">
          <div className="glass rounded-2xl p-4 flex items-center justify-between">
            <div className="min-w-0">
              <p className="text-gray-400 font-semibold">Theme</p>
              ...
              <button
                ...
                className={`w-full flex items-center justify-between p-4 rounded-xl transition-all ${
                  isActive
                    ...
                    : 'glass text-gray-600 dark:text-gray-400 text-black dark:text-gray-400 hover:bg-black/5 dark:hover:bg-white/10 border border-black/10 dark:border-transparent'
                }`}
              >
