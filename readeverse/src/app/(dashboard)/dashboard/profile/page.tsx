        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="glass rounded-3xl p-6 md:p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { label: 'Books Finished', value: '42', icon: BookOpen, color: 'text-blue-400', bg: 'bg-blue-400/10' },
                { label: 'Reading Hours', value: '128', icon: Clock, color: 'text-purple-400', bg: 'bg-purple-400/10' },
                { label: 'Current Streak', value: '14', icon: Flame, color: 'text-orange-400', bg: 'bg-orange-400/10' },
                { label: 'Total Pages', value: '12.4k', icon: Target, color: 'text-emerald-400', bg: 'bg-emerald-400/10' },
              ].map((stat, i) => {
                const Icon = stat.icon;
                return (
                  <div key={i} className="bg-white/5 rounded-2xl p-5 border border-white/10 hover:-translate-y-1 transition-transform">
