...
export default function SignupPage() {
  ...
  return (
    <div className="auth-page w-full max-w-md p-8 glass border-2 border-black/10 dark:border-white/10 rounded-3xl shadow-lg relative overflow-hidden my-8 text-black dark:text-white">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2 text-primary dark:text-primary">Create Account</h1>
        <p className="text-primary dark:text-primary text-sm font-medium">Join READ-E-VERSE and unlock the universe</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1">
          <label className="text-sm font-semibold text-black dark:text-gray-200 ml-1">Full Name</label>
        ...
        <div className="space-y-1">
          <label className="text-sm font-semibold text-black dark:text-gray-200 ml-1">Password</label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="space-y-1">
          <label className="text-sm font-semibold text-black dark:text-gray-200 ml-1">Confirm Password</label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <Lock className="h-5 w-5 text-gray-700 dark:text-gray-300" />
            </div>
  ...
  <span className="text-xs text-primary dark:text-primary font-semibold">
    OR CONTINUE WITH
  </span>
  <div className="flex-1 h-px bg-black dark:bg-white/10" />
</div>
...
<p className="mt-8 text-center text-sm text-black dark:text-gray-400">
  ...
  <Link
    href="/login"
    className="text-primary dark:text-primary font-medium hover:text-black dark:hover:text-primary/80 transition-colors"
  >
    Sign in
  </Link>
</p>
